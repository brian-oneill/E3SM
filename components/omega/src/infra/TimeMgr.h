...
class TimeInterval {
 ...
 public:
   ...
   /// Uses calendar relationships when possible (e.g., 1 year = 12 months
   /// exactly). For calendars with variable month lengths, months are only
   /// divisible by 1-day intervals. \return true if evenly divisible, false
   /// otherwise.
